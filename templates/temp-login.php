...
<!--    <ic:informationCard xmlns:ic="<?php echo $this->data['InfoCard']['schema'] ?>" name="xmlToken" 
        ...
        <?php
        if ($this->data['InfoCard']['issuerPolicy'] != '') {
            echo 'issuerPolicy="' . $this->data['InfoCard']['issuerPolicy'] . '"';
        }
        if ($this->data['InfoCard']['tokenType'] != '') {
            echo 'tokenType="' . $this->data['InfoCard']['tokenType'] . '"';
        }
        if ($this->data['InfoCard']['privacyURL'] != '') {
            echo 'privacyUrl="' . $this->data['InfoCard']['privacyURL'] . '"';
        }
        if ($this->data['InfoCard']['privacyVersion'] != '') {
            echo 'privacyVersion="' . $this->data['InfoCard']['privacyVersion'] . '"';
        } ?>>
        <?php
        ...
        if ($this->data['InfoCard']['tokenType'] != '') {
            echo '<PARAM Name="tokenType" Value="' . $this->data['InfoCard']['tokenType'] . "\">\n";
        }
        if ($this->data['InfoCard']['privacyURL'] != '') {
            echo '<PARAM Name="privacyUrl" Value="' . $this->data['InfoCard']['privacyURL'] . "\">\n";
        }
        if ($this->data['InfoCard']['privacyVersion'] != '') {
            echo '<PARAM Name="privacyVersion" Value="' . $this->data['InfoCard']['privacyVersion'] . "\">\n";
        }?>
